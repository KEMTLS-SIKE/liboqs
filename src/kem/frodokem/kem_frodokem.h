...
OQS_KEM *OQS_KEM_frodokem_640_aes_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_640_aes_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
...
OQS_KEM *OQS_KEM_frodokem_640_shake_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_640_shake_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
...
OQS_KEM *OQS_KEM_frodokem_976_aes_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_976_aes_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
...
OQS_KEM *OQS_KEM_frodokem_976_shake_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_976_shake_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
...
OQS_KEM *OQS_KEM_frodokem_1344_aes_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_aes_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
...
OQS_KEM *OQS_KEM_frodokem_1344_shake_1cca_new(void);
...
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_shake_decaps_1cca(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key);
#endif
