...
#define crypto_kem_async_batch_deinit OQS_KEM_sike_p434_compressed_async_deinit
#define crypto_kem_async_batch_init OQS_KEM_sike_p434_compressed_async_init
#define crypto_kem_keypair_async OQS_KEM_sike_p434_compressed_keypair_async
#define crypto_kem_keypair OQS_KEM_sike_p434_compressed_keypair
#define crypto_kem_enc_async OQS_KEM_sike_p434_compressed_encaps_async
