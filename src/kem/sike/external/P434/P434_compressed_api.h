...
int OQS_KEM_sike_p434_compressed_async_init(void);
int OQS_KEM_sike_p434_compressed_async_deinit(void);
int OQS_KEM_sike_p434_compressed_keypair_async(unsigned char *pk, unsigned char *sk);
...
int OQS_KEM_sike_p434_compressed_encaps_async(unsigned char *ct, unsigned char *ss, const unsigned char *pk);
...
void oqs_kem_sidh_p434_compressed_random_mod_order_A(unsigned char *random_digits);

// Generation of Bob's secret key
// Outputs random value in [0, 2^Floor(Log(2,3^137)) - 1] to be used as Bob's private key
void oqs_kem_sidh_p434_compressed_random_mod_order_B(unsigned char *random_digits);
