...
OQS_API OQS_STATUS OQS_KEM_sike_p434_1cca_compressed_encaps_ciphertext(uint8_t *ciphertext, uint8_t *ephemeral_secret);
...
OQS_API OQS_STATUS OQS_KEM_sike_p503_1cca_compressed_encaps_ciphertext(uint8_t *ciphertext, uint8_t *ephemeral_secret);
...
OQS_API OQS_STATUS OQS_KEM_sike_p610_1cca_compressed_encaps_ciphertext(uint8_t *ciphertext, uint8_t *ephemeral_secret);
...
OQS_API OQS_STATUS OQS_KEM_sike_p751_1cca_compressed_encaps_ciphertext(uint8_t *ciphertext, uint8_t *ephemeral_secret);
